...
namespace E_CommerceStore_Udemey.WEB.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        {
            if (!_roleManager.RoleExistsAsync(RolesConstant.Role_Admin).GetAwaiter().GetResult())
            {
                ...
                _roleManager.CreateAsync(new IdentityRole(RolesConstant.Role_User_Comp)).GetAwaiter().GetResult();
                _roleManager.CreateAsync(new IdentityRole(RolesConstant.Role_User_Indi)).GetAwaiter().GetResult();
